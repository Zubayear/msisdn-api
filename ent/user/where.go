...
func RolesEQ(v model.Role) predicate.User {
	vc := v
	return predicate.User(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldRoles), vc))
	})
}

// RolesNEQ applies the NEQ predicate on the "roles" field.
func RolesNEQ(v model.Role) predicate.User {
	vc := v
	return predicate.User(func(s *sql.Selector) {
		s.Where(sql.NEQ(s.C(FieldRoles), vc))
	})
}

// RolesIn applies the In predicate on the "roles" field.
func RolesIn(vs ...model.Role) predicate.User {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func RolesNotIn(vs ...model.Role) predicate.User {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
